  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://vipulksharma-github-io-89p3yjfsg-vipulksharma.vercel.app${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://vipulksharma-github-io-89p3yjfsg-vipulksharma.vercel.app${router.asPath}`}
        />
